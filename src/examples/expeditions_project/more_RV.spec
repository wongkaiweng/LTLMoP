...
# (order is not cancelled until delivery)
#if you were sensing RiceOrdered and you were not activating deliver then do order_rice
#if you were sensing SakeOrdered and you were not activating deliver then do order_sake
