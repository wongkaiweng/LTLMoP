...
#####################################
if you have finished office1 then do not (alice_office1 or alice_roadTL or alice_roadBL)
if you have finished roadTL then do not (alice_roadTL or alice_roadTR or alice_office1)
if you have finished roadBL then do not (alice_roadBL or alice_roadBR or alice_office1)
