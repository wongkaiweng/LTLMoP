...
always not finished kitchen and not finished prepArea
#####################################
# ASSUMPTIONS ABOUT THE OTHER ROBOT #
#####################################
if you have finished customer then do not (chef_customer or chef_hallway)
if you have finished hallway then do not (chef_hallway or chef_customer or chef_order or chef_counter)
if you have finished counter then do not (chef_counter or chef_hallway or chef_order or chef_commonArea)
if you have finished order then do not (chef_order or chef_hallway or chef_counter or chef_commonArea)
