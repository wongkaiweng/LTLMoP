...
if you have finished L2 then do not (alice_L2 or alice_L1 or alice_L3 or alice_ML)
...
if you have finished R2 then do not (bob_R2 or bob_R1 or bob_R3 or bob_MR)
