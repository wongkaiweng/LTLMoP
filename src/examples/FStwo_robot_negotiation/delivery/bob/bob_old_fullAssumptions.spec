...
if you are sensing trashInHallwayCentral then visit hallwayCentral
...
if you have finished atrium then do not (alice_library or alice_atrium or alice_storageTop or alice_storageBottom or alice_hallwayCentral)
