if [ $1 == 'bob' ]; then
    ...
    java -ea -Xmx512m -cp /home/catherine/LTLMoP/src/etc/jtlv/jtlv-prompt1.4.0.jar:/home/catherine/LTLMoP/src/etc/jtlv/GROne GROneMain /home/catherine/LTLMoP/src/examples/two_robot_negotiation/city/alice/alice_wander.smv  /home/catherine/LTLMoP/src/examples/two_robot_negotiation/city/alice/alice_wander.ltl  
